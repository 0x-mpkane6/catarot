...
Một lần chuyển cảnh diễn ra gọn trong vài bước: người dùng chạm chọn chế độ, tấm phủ `CosmicVeil` hiện lên che kín màn (khoảng 300ms), nội dung được đổi ngay lúc đang bị che, rồi tấm phủ tan dần (khoảng 640ms) để lộ màn mới. Tất cả đều chỉ dùng `transform` và `opacity` nên giữ được độ mượt trên điện thoại.
