...
> Thông qua CATAROT, nhóm không chỉ xây dựng một website có đầy đủ các chức năng cơ bản như đăng ký, đăng nhập, quản lý dữ liệu và tương tác người dùng, mà còn thử nghiệm cách tích hợp AI vào một hệ thống web thực tế. Từ quá trình thiết kế giao diện, xây dựng API, tổ chức cơ sở dữ liệu, xử lý luồng người dùng đến triển khai ứng dụng, nhóm đã có cái nhìn rõ hơn về cách một sản phẩm web hoàn chỉnh được hình thành và vận hành.

> *Sau đồ án này, chúng em đã biết làm web và hiểu hệ thống web hoạt động như thế nào.*
